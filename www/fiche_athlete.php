...
?>
        ...
        var options = {
          title: 'Meilleures performances � la table de cotations par ann�e'
        };
...
<?php  
if ( $nb == 0 ) {   
    echo '<div class="alert alert-danger danger"><b>Pas de performances trouv�es pour l\'athl�te [' . $param_nom . ' ' . $param_prenom . '], ou ses nom-pr�nom ne sont pas orthographi�s comme dans la base (v�rifiez dans le tableau des athl�tes du club si vous le connaissez)</b></div>';
